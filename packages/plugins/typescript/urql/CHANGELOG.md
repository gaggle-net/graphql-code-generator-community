...
- [#411](https://github.com/gaggle-net/graphql-code-generator-community/pull/411)
  [`218778010`](https://github.com/gaggle-net/graphql-code-generator-community/commit/2187780109269543d9024a9ee929dca215c5f406)
  Thanks [@saihaj](https://github.com/saihaj)! - Generates optional or required options argument for
  subscriptions if variables are required or not.
...
- 7f2bf153: Prefer generating React Hooks over React data components by default
  ...
  If you are using the generated Component from that plugin, you can turn it on by adding
  `withComponent: true` to your configuration.
