...
- df45f0c37: Added `StrictTypedTypePolicy`, allowing only known types to be expressed in
...
- 5e792ff3: Added `requireKeyFields` and `requirePoliciesForAllTypes` to allow more flexibility with
  the output
